...
ini_temp = 0
# Analysis info
analysis = 'disp'   #specifying analysis type eg pre-scribed displacement, force etc
#add things like steady state, number of increments, automatic incrementation on or off etc
